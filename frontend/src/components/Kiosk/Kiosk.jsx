  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full relative">
      <div className="kiosk-glass flex flex-col items-center max-w-2xl w-full px-10 py-14">
        <h1 className="kiosk-title">Control de Fichajes</h1>
        ...
        {feedback && !modal && (
          <div className="kiosk-feedback" style={{background: feedback.success ? 'rgba(67,233,123,0.18)' : 'rgba(250,112,154,0.18)', color: feedback.success ? '#43e97b' : '#fa709a'}}>{feedback.msg}</div>
        )}
      </div>
      ...
      {modal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="kiosk-glass flex flex-col items-center min-w-[340px] px-10 py-12 relative animate-fadein z-10 shadow-2xl border-2 border-blue-400">
            ...
            <input
              className="border-2 border-blue-400 px-8 py-4 rounded-xl mb-8 text-2xl text-center focus:outline-none focus:border-blue-500 transition-all w-72 bg-white/80 tracking-widest shadow"
              value={dni}
